...
#SBATCH --output=/cluster/home/nbhatt04/lean_pipeline/logs/ach_occupancy_%j.log
...
cd /cluster/home/nbhatt04/lean_pipeline/05_ach_occupancy/yaml_inputs
mkdir -p predictions
...
for yaml_file in /cluster/home/nbhatt04/lean_pipeline/05_ach_occupancy/yaml_inputs/*.yaml; do
